...
A nu se confunda cu `test_document_intelligence.py`, care testeaza cu totul
altceva: agentul RAG din `app/agents/document_intelligence.py`. Numele se bat
cap in cap fiindca produsul Azure si agentul se cheama la fel; directorul e cel
care ii desparte (`providers/` vs `agents/`). Fisierul asta e numit dupa ce
face — citirea unei adeverinte — tocmai ca sa nu se mai ciocneasca.
